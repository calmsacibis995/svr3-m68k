...
all:
	if m68k ; then make -e -f  libc881u.mk specific MACHINE=m68k ; fi
...
specific:
	...
	cd ../libc881/m68k; make -e all CC=$(CC) FP=$(FP) DBLALIGN=$(DBLALIGN)   
	#
	...
	cd object; make -e -f ../../libc881/m68k/makefile archive \
...
move:
	...
	rm -f $(LIB)/lib$(VARIANT)c881u.a
	cp lib.libc $(LIB)/lib$(VARIANT)c881u.a
	chmod $(PROT) $(LIB)/lib$(VARIANT)c881u.a
	chmod -x $(LIB)/lib$(VARIANT)c881u.a	# not executable
	chgrp $(GRP) $(LIB)/lib$(VARIANT)c881u.a
	chown $(OWN) $(LIB)/lib$(VARIANT)c881u.a

	$(PROF)if test -d $(LIBP) ; \
		then : ; else mkdir $(LIBP) ; fi 
	$(PROF)rm -f $(LIBP)/lib$(VARIANT)c881u.a
	$(PROF)cp libp.libc $(LIBP)/lib$(VARIANT)c881u.a
	$(PROF)chmod $(PROT) $(LIBP)/lib$(VARIANT)c881u.a
	$(PROF)chmod -x $(LIBP)/lib$(VARIANT)c881u.a	# not executable
	$(PROF)chgrp $(GRP) $(LIBP)/lib$(VARIANT)c881u.a
	$(PROF)chown $(OWN) $(LIBP)/lib$(VARIANT)c881u.a

install: all save move

#--------------------------

uninstall:	$(LIB)/OLDlib$(VARIANT)c881u.a $(LIBP)/OLDlib$(VARIANT)c881u.a \
		$(LIB)/OLD$(VARIANT)mcrt0.o $(LIB)/OLD$(VARIANT)crt0.o
		
		mv -f $(LIB)/OLDlib$(VARIANT)c881u.a $(LIB)/lib$(VARIANT)c881u.a
		mv -f $(LIBP)/OLDlib$(VARIANT)c881u.a $(LIBP)/lib$(VARIANT)c881u.a
...
save:		
	if test -f $(LIB)/lib$(VARIANT)c881u.a ; \
	then \
		rm -f $(LIB)/OLDlib$(VARIANT)c881u.a ; \
		cp $(LIB)/lib$(VARIANT)c881u.a $(LIB)/OLDlib$(VARIANT)c881u.a ; \
		chmod $(PROT) $(LIB)/OLDlib$(VARIANT)c881u.a ; \
		chmod -x $(LIB)/OLDlib$(VARIANT)c881u.a ; \
		chgrp $(GRP) $(LIB)/OLDlib$(VARIANT)c881u.a ; \
		chown $(OWN) $(LIB)/OLDlib$(VARIANT)c881u.a ; \
	fi

	$(PROF)if test -f $(LIBP)/lib$(VARIANT)c881u.a ; \
	then \
		rm -f $(LIBP)/OLDlib$(VARIANT)c881u.a ; \
		cp $(LIBP)/lib$(VARIANT)c881u.a $(LIBP)/OLDlib$(VARIANT)c881u.a ;\
		chmod $(PROT) $(LIBP)/OLDlib$(VARIANT)c881u.a ; \
		chmod -x $(LIBP)/OLDlib$(VARIANT)c881u.a ; \
		chgrp $(GRP) $(LIBP)/OLDlib$(VARIANT)c881u.a ; \
		chown $(OWN) $(LIBP)/OLDlib$(VARIANT)c881u.a ; \
	fi
...
clean:
	...
	if m68k ; then cd ../libc881/m68k ; make clean ; fi
...
clobber: clean
	...
	if m68k ; then cd ../libc881/m68k ; make clobber ; fi

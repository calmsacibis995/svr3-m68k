...
/* the var is changed from 'from' to 'From' due to some strangeness in the
** latest compiler.  After running through 'xstr' we  can't compile this
** file due to 'from redeclared' errors ... sigh. -wjc
*/
copyw(to, From, size)

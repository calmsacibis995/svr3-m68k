...
ROOT =
INSDIR = $(ROOT)/etc
#(mat)TOUCH=$(CH)/bin/touch
TOUCH=:

SCRIPTS= bcheckrc brc inittab fstab rstab mountall rc0 rc2 rc3 \
	rmount rmountall rumountall shutdown umountall linkboot
...
linkboot::
	...
	cp init.d/LINKBOOT $(INSDIR)/linkboot
	$(CH)chmod 744 $(INSDIR)/linkboot
	$(CH)chgrp sys $(INSDIR)/linkboot
	$(TOUCH) 0101000070 $(INSDIR)/linkboot
	$(CH)chown root $(INSDIR)/linkboot

...
ALL: \
		$(PARTS)
	cd tools;  make ROOT=$(ROOT)
	cd shell;  make ROOT=$(ROOT)
	cd include;  make ROOT=$(ROOT)
	cd csub;  make ROOT=$(ROOT)
	cd cmain;  make ROOT=$(ROOT)
	cd check;  make ROOT=$(ROOT)
	cd etc;  make ROOT=$(ROOT)
	cd admin;  make ROOT=$(ROOT)

...
*/
	...
	((struct user *)uu)->u_ar0 =
		...
		datmap.b2 = USRSTACK;	/* loc of usr stack, in <sys/seg.h>, <sys/param.h> for m68k */
...
#endif
#if m68k
		/* m68k  stack grows down from USRSTACK, in <sys/param.h> */
		/*  stksiz no longer includes sizeof user area  */
...
ADDR
setuaddr() 
{	/* this code is a modified version of nlist(3c) */
	struct filehdr buf;

...
SGS2DEFS= -DFLEXNAMES -DSTKCK -DPROFILE -Dm68k -DTWOPASS -DITREES $(FORTDEF)
...
f77pass1:	$(OBJECTS1) 
	@echo LOAD
	$(CC) -g $(LDFLAGS) $(OBJECTS1) -o f77pass1
	@size f77pass1
...
lintem:	machdefs gram.c
	lint $(CFLAGS) $(FORTDEF) $(LDFLAGS) -I$(M) -I$(P) -abhvxn \
	$(SOURCE1)
...
f77pass2:	$(OBJECTS2) 
	@echo LOAD
	$(CC) -g $(LDFLAGS) $(OBJECTS2) -o f77pass2
	@size f77pass1
...
install: all
	...
	@strip f77pass1
	@strip f77pass2
	/etc/install -n $(BINDIR) f77
	/etc/install -n $(LIBDIR) f77pass1
	/etc/install -n $(LIBDIR) f77pass2

clean:
	-rm -f gram.c *.o tokdefs machdefs

clobber:	clean
	-rm -f f77 f77pass1 f77pass2

...
M = /usr/src/cmd/sgs/comp2/common
P = /usr/src/cmd/sgs/comp2/m68k
DIRBUF = /crp/c/cmf
DIRNUC = /crp/c/cmf
DIRMIP = .
DIRPCC = .
...
CFLAGS = -O $(FORTDEF) $(DEFS) -I$(DIRMIP) -I. -I$(MACHDIR) -I$(FAMDIR)
...
f77comp:	$(OBJECTS) nfort.o freader.o fallo.o fmatch.o ftable.o \
	...
	@echo LOAD
	$(CC) -O $(LDFLAGS) $(OBJECTS) nfort.o freader.o fallo.o fmatch.o \
...
lintem:	machdefs gram.c
	lint $(CFLAGS) $(LDFLAGS) -I$(M) -I$(P) -abhvxn \
...
3bxf77comp:	$(OBJECTS)
	@echo LOAD
	@$(CC) $(LDFLAGS) $(OBJECTS) -o 3bxf77comp
	@size 3bxf77comp

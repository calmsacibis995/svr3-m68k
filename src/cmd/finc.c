...
/*
	...
	- finc processes the command line, for selection criteria.
...
#endif
#ifdef u3b2
#define	OBLKFACT	31	/* 31 blocks/segment on the streaming tape */
#define	ONE_REEL	45570   /* 6 streams * 245 segments * 31 blocks */
#endif

...
/*	@(#) optab.base:	2.1 83/07/08	*/
{
    ...
    { "and.b",	AND_B,	2,	1,	{1,1},	1,	NOOPP,	OF_CC },
    { "and.l",	AND_L,	2,	1,	{4,4},	4,	NOOPP,	OF_CC },
    { "and.w",	AND_W,	2,	1,	{2,2},	2,	NOOPP,	OF_CC },
    ...
    { "eor.b",	EOR_B,	2,	1,	{1,1},	1,	NOOPP,	OF_CC },
    { "eor.l",	EOR_L,	2,	1,	{4,4},	4,	NOOPP,	OF_CC },
    { "eor.w",	EOR_W,	2,	1,	{2,2},	2,	NOOPP,	OF_CC },
    ...
    { "or.b",	OR_B,	2,	1,	{1,1},	1,	NOOPP,	OF_CC },
    { "or.l",	OR_L,	2,	1,	{4,4},	4,	NOOPP,	OF_CC },
    { "or.w",	OR_W,	2,	1,	{2,2},	2,	NOOPP,	OF_CC },

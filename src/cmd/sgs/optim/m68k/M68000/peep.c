...
/*	@(#)peep.c	7.3		*/
/* peep.c */
static char SCCSID2[] = " Module @(#)peep.c Version 7.3, Creation date 86/09/07";
...
    /* Another mov.[bwl] case:
    ...
    */

	{
	    ...
	    {
		register RAND ** backrands;	/* previous nodes operands */
		unsigned int size;		/* operand size */

		backrands = back->userdata.ud_rand;	/* points at operands */
							/* on previous node */

h21304
s 00000/00000/00924
d D 1.3 86/08/18 08:45:27 fnf 3 2
c Checkpoint changes at first working shared library version
e
s 00042/00026/00882
d D 1.2 86/07/30 14:24:24 fnf 2 1
c Add macro based C debugging package macros.
e
s 00908/00000/00000
d D 1.1 86/07/29 14:31:57 fnf 1 0
...
E 2
I 2
 *	DBUG_RETURN( (int) (hashval % HASHSIZE) );
E 2
 */
...
E 2
I 2
	DBUG_4 ("hval", "hash value for '%s' is %d", name, tmp % HASHSIZE);
	DBUG_RETURN ( tmp % HASHSIZE );
E 2
}
/*eject*/
SYMTAB *
...
I 2
	DBUG_ENTER ("findsym");
	DBUG_3 ("sym1", "find symbol table entry for '%s'", name);
E 2
/*
...
E 2
I 2
		DBUG_RETURN( (SYMTAB *) ( (long) xsymptr[acid/XSMTBSZ] + ((acid % XSMTBSZ) * SYMSIZ)) );
E 2
...
E 2
I 2
		DBUG_RETURN( (AUXTAB *) ( (long) xauxptr[acid/XAXTBSZ] + ((acid % XAXTBSZ) * AUXSIZ)) );
E 2
...
E 2
I 2
			DBUG_RETURN(getaux(sym->smauxid));
E 2
...
E 2
I 2
		DBUG_RETURN(getaux(aux->axchainid));
E 2

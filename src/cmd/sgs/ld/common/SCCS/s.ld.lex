h65295
s 00000/00000/00490
d D 1.3 86/08/18 08:44:50 fnf 3 2
c Checkpoint changes at first working shared library version
e
s 00044/00002/00446
d D 1.2 86/07/30 14:21:26 fnf 2 1
c Add macro based C debugging package macros.
e
s 00448/00000/00000
d D 1.1 86/07/29 14:31:41 fnf 1 0
...
I 2
	DBUG_ENTER ("main");
#ifndef NO_DBUG
	dbugflag(argc,argv);	/* Special handling for debugging args... */
#endif
E 2
	initpass1();
	argptr = argv;
...
#ifndef NO_DBUG
/*
 *	Because this program delays processing it's arguments until it
 *	has done some other stuff, and because we want to immediately
 *	enable the macro based debugging stuff if necessary, we must
 *	do our own scanning of the argument list, looking for the
 *	special debugging control string (which begins with '-#').
 *
 *	Here we allow whitespace between the flag and it's argument,
 *	ala getopt().  This may not be supported for the other arguments.
 */

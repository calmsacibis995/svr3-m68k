h11504
s 00025/00008/00430
d D 1.2 86/08/18 08:49:07 fnf 2 1
c Checkpoint changes at first working shared library version
e
s 00438/00000/00000
d D 1.1 86/07/31 14:39:18 fnf 1 0
...
E 2
	...
	for (i=0; i<nscns; i++) {
		...
		/* skip .text, .data and .bss sections */
...
I 2
				if (parstab == NULL) {
					/* Ignore "end" for now; fnf */
					if (strcmp(name, "end") == 0) goto next;
					fatal("Undefined symbol %s in file %s not defined in archive",name,curobj->objname); 
				}
E 2

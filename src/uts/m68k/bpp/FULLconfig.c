...
**			the system.
**
**  NOTES:		This is the standard version of the configuration
**			file which supports (1) VME330 board and (2) VME333
**			boards.
**
...
CI_CPUTAB_T	ci_initab[CI_MAX_CPU+1] =
{
	...
	*/
	...
	MAX_330_BUFS			/* maximum number of remote BUFs */
    	...
    	/* 
	**  VME333 Board number 1 -- cpu 2 
	*/
    {
	2,				/* cpu number */
	VME333_BOARD,			/* board type */
	0,				/* initialization function */
	v33_1_probe,			/* board probe routine */
	v33_1_ctrl_write,		/* control write function */
	v33_1_data_write,		/* data write function */
	v33_1_status_read,		/* status read function */
	v33_1_intr_write,		/* interrupt write function */
	0x100,				/* interrupt mask */
	v33_1_rst_write,		/* board reset function */
	0x200,				/* reset function mask */
	2,				/* host interrupt level */
	0xE7,				/* interrupt vector location */
	1,				/* initialization type -- not used */
	FALSE,				/* life flag - dead or alive */
	FALSE,				/* cpu running flag */
	N_333_LCL_BPES,        		/* number of local BPEs to create */
	N_333_REM_BPES,			/* number of remote BPEs to create */
	MAX_EPB_SIZE,			/* size of this channel's EPBs */
	N_333_LCL_EPBS,			/* number of local EPBs to create */
	N_333_REM_EPBS,			/* number of remote EPBs to create */
	MAX_BUF_SIZE,			/* size of this channel's buffers  */
	N_333_LCL_BUFS,			/* number of local BUFs to create */
	N_333_REM_BUFS,			/* number of remote BUFs to create */
	MIN_333_BUFS,			/* minimum number of remote BUFs */
	MAX_333_BUFS			/* maximum number of remote BUFs */
    },
    	/* 
	**  VME333 Board number 2 -- cpu 3 
	*/
    {
	3,				/* cpu number */
	VME333_BOARD,			/* board type */
	0,				/* initialization function */
	v33_2_probe,			/* board probe routine */
	v33_2_ctrl_write,		/* control write function */
	v33_2_data_write,		/* data write function */
	v33_2_status_read,		/* status read function */
	v33_2_intr_write,		/* interrupt write function */
	0x100,				/* interrupt mask */
	v33_2_rst_write,		/* board reset function */
	0x200,				/* reset function mask */
	2,				/* host interrupt level */
	0xE8,				/* interrupt vector location */
	1,				/* initialization type -- not used */
	FALSE,				/* life flag - dead or alive */
	FALSE,				/* cpu running flag */
	N_333_LCL_BPES,        		/* number of local BPEs to create */
